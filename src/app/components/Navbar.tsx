...
export default function Navbar() {
  ...
  <span className="text-white">edu</span><span className="text-blue-800">/</span><span className="text-white">Prompt</span>
      ...
      <div className="flex items-center gap-8">
        ...
        <Link href="/login" className="text-base font-semibold text-white hover:underline underline-offset-4">Login</Link>
        <Link href="/register" className="ml-2 bg-[#2d23e6] hover:bg-[#1a0fbf] text-white font-semibold py-2 px-5 rounded-lg transition shadow text-base">Get Started</Link>
      </div>
    </nav>
  );
}

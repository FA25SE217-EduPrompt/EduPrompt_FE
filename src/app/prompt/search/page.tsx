...
const SAMPLE_PROMPTS: Prompt[] = [
    ...
    { id: '4', title: 'Historical Event Analysis', category: 'History', rating: 4.6, instruction: 'Help students analyze historical events by examining causes, effects, and different perspectives with supporting evidence.', inputExample: 'Analyze the causes of World War I' },
    { id: '5', title: 'Creative Writing Story Starter', category: 'English', rating: 4.5, instruction: 'Generate engaging story prompts and provide constructive feedback on creative writing pieces.', inputExample: 'Write a short story about a time traveler' },
];

const MY_COLLECTIONS = [
    { id: 'c1', name: 'Grade 10 English', promptCount: 12 },
    { id: 'c2', name: 'Mathematics Essentials', promptCount: 8 },
    { id: 'c3', name: 'Science Experiments', promptCount: 15 },
    { id: 'c4', name: 'History Analysis Tools', promptCount: 6 },
];
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-2">
                            <div className="flex-1">
                                ...
                                <select
                                    value={slot === 'A' ? modelA : modelB}
                                    onChange={(e) => slot === 'A' ? setModelA(e.target.value) : setModelB(e.target.value)}
                    ...
                    <div className="flex items-center space-x-4 mb-3">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                onFocus={() => {
                                    if (searchQuery.length > 0 || activePromptSlot) {
                                        setShowSearchDropdown(true);
                                    }
                                }}
                                                ...
                                                <div key={collection.id}>
                                                    ...
                                                    >
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-xs text-gray-500">({collection.promptCount})</span>
                                                        </div>
                                                    </button>
                                                    {expandedCollection === collection.id && (
                                                        <div className="ml-6 space-y-1 animate-in fade-in slide-in-from-top-1 duration-200">
                                                            {SAMPLE_PROMPTS.slice(0, 2).map(prompt => (
                                                                <button

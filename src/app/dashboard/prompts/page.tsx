    ...
    return (
        <main className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard
                    ...
                    value={quotaData?.data?.optimizationQuotaRemaining !== undefined
                        ? `${quotaData.data.optimizationQuotaLimit - quotaData.data.optimizationQuotaRemaining} / ${quotaData.data.optimizationQuotaLimit}`
                        : "Loading..."}
                    icon={<BoltIcon />}
                    gradientClass="from-brand-secondary to-brand-secondary/70" // Sky Blue
                />
                <StatCard
                    ...
                    value={quotaData?.data?.individualTokenRemaining?.toLocaleString() || "Loading..."}
                    icon={<WalletIcon />}
                    gradientClass="from-brand-primary to-brand-primary/70" // Dark Slate
                />
            </section>
            ...
            <section>
                <div className="flex items-center justify-between mb-3">
                    <h2 className="text-lg font-semibold text-text-primary flex items-center gap-2">
                        {isSearching ? 'Search Results' : 'My Prompts'}
                    </h2>
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-12 text-gray-500">
                        {isSearching
                            ? `No prompts found matching "${executedSearchQuery}"`
